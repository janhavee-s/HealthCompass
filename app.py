...
from HackX.project.orchestrator import recommend_hospitals

# ---------------- UI ----------------
st.title("🏥 HealthCompass - Healthcare Navigator")
...
# ---------------- INSURANCE ----------------
insurance_df = pd.read_csv("HackX/data/insurance.csv")
